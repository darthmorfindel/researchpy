...
with open(sys.argv[1], 'r') as data_in: # opening file, making it a Python object
    ...
    time_range1 = range(44521,45722) # time of interest -- CHANGE MANUALLY
    gdlat_vals = []
    glon_vals = []
    times = []
    time_labels = []
...
map = Basemap(projection='stere', width=8E6, height=8E6, lat_0=-90, lon_0=45, resolution='l')
map.drawcoastlines()
...
plt.savefig(date + satellite + 'South_overflight_1222.png') # CHANGE TIME MANUALLY
plt.show()
